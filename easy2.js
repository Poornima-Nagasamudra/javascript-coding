...
function numberOfStepsToReachOneArray(x) {
   if( x === 1){
     return 0
   } else if (x % 2 === 0){
     return x = x/2
...
console.log(numberOfStepsToReachOneArray(12))
console.log(numberOfStepsToReachOneArray(6))
console.log(numberOfStepsToReachOneArray(3))
console.log(numberOfStepsToReachOneArray(10))